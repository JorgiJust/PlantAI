...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<"diagnostico" | "historial">("diagnostico");
  ...
  const runDiagnosis = async () => {
    ...
    setTimeout(async () => {
      ...
      setIsLoading(false);
      showPopup("Diagnostico listo", "Se analizo la planta y guardamos el resultado.", "success");
    }, 1200);
  };
